    ...
    <div className="relative min-h-screen flex items-center justify-center bg-[#030611] p-4">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-[28px] text-[#f5f7ff] font-serif">{t('register.title')}</h1>
          <p className="text-[13px] text-[#8892b0] mt-2">{t('register.subtitle')}</p>
        </div>
        ...
        <Card className="bg-[linear-gradient(180deg,rgba(14,20,44,0.6),rgba(8,12,28,0.6))] backdrop-blur-[20px] border-white/[0.08] rounded-[14px]">
          <CardContent className="p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
              <div>
                <Label className="text-[11px] font-mono uppercase tracking-[0.08em] text-[#8892b0]">{t('fields.name')}</Label>
              ...
              <div>
                <Label className="text-[11px] font-mono uppercase tracking-[0.08em] text-[#8892b0]">{t('fields.confirmPassword')}</Label>
                <div className="relative mt-1.5">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#545d78]" />
                  <Input
                    type="password"
              ...
              >
                {isSubmitting ? <Loader2 className="w-4 h-4 animate-spin" /> : t('register.submit')}
              </Button>
            </form>
            ...
            <div className="text-center mt-6 text-[13px] text-[#8892b0]">
              ...
              <Link to="/login" className="text-[#7aadff] hover:text-[#4f8eff]">{t('register.signInLink')}</Link>
            </div>
          </CardContent>
        </Card>
      </div>
