...
import { registerApi } from '@/services/api-client';
...
export function RegisterPage() {
  ...
  const oauthProviders = [
    { name: 'Google', icon: Globe, color: '#ea4335' },
    { name: 'Apple', icon: Apple, color: '#f5f7ff' },
        ...
        <Card className="bg-[linear-gradient(180deg,rgba(14,20,44,0.6),rgba(8,12,28,0.6))] backdrop-blur-[20px] border-white/[0.08] rounded-[14px]">
          <CardContent className="p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
              ...
              <div className="flex items-start gap-2">
                ...
                <Label htmlFor="terms" className="text-[12px] text-[#8892b0] font-normal cursor-pointer">
                  I agree to the{' '}
                  <Link to="#" className="text-[#7aadff] hover:text-[#4f8eff]">Terms of Service</Link>
                  {' '}and{' '}
                  <Link to="#" className="text-[#7aadff] hover:text-[#4f8eff]">Privacy Policy</Link>
                </Label>
              </div>
            ...
            <div className="relative my-6">
              ...
              <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#030611] px-3 text-[11px] text-[#545d78]">or continue with</span>
            </div>
              ...
              {oauthProviders.map((provider) => {
                ...
                return (
                  <Button
                    ...
                    onClick={() => console.log(`OAuth: ${provider.name}`)}
                  >
